...
import { idlFactory } from "./candid/core.did.js";
export { idlFactory } from "./candid/core.did.js";

export const createActor = (canisterId, options = {}) => {
  var args = {};

  args["host"] = process.env.REACT_APP_SPIN_CANISTER_ADDRESS; //canister deploy location on ICP - ask canister developer for this
  ...
  var coreId = "p7g6o-ayaaa-aaaam-acwea-cai";
