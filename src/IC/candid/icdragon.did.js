export const idlFactory = ({ IDL }) => {
  ...
  const ICDragon = IDL.Service({
    ...
    emergencySendEyes: IDL.Func([IDL.Principal, IDL.Nat], [TransferResult], []),
    ...
    getTicketPurchaseHash: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Vec(PaidTicketPurchase)))], ["query"]),
    ...
    getUserTicketList: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Nat))], ["query"]),
    ...
    toText: IDL.Func([IDL.Record({ te: IDL.Text })], [IDL.Vec(IDL.Nat8)], []),
