    ...
    <section className="relative w-screen h-screen overflow-hidden" onContextMenu={handleContextMenu}>
      ...
      <div className="relative flex flex-col justify-center items-center pt-12">
        ...
        <div className="flex justify-center items-center mt-10 relative h-full w-full">
          ...
          <div className={`absolute ${logedIn ? "bottom-28" : "bottom-3"} md:bottom-11 flex flex-col justify-center items-center gap-12 lg:gap-16`}>
            {/* Bet Card */}
            {logedIn && (
            ...
            {logedIn && <div className="fixed bottom-3 justify-center items-center text center font-alatsi text-[#FFF4BC] text-2xl drop-shadow-md">Hold To Shoot</div>}
