...
const RoundInfo = ({
  ...
  return (
    <section
      id="player-data"
      className="hidden xl:block z-10 w-1/3 text-dark-blue justify-start items-start h-full py-6 order-3 xl:order-3 "
    >
      {spinGameData ?
        <div className="bg-primary-gray rounded-lg p-4">
          <div className="text-xl font-bold mb-4 text-center">
            Round #{Number(spinGameData.id)}
          </div>
          <div className="flex flex-row justify-between items-center mb-4">
            <div className="flex flex-col justify-center items-start">
              <div className=" text-xl font-bold">
                {(Number(spinGameData.totalReward) / 100000000).toLocaleString()}{" "}
                ICP
              </div>
            ...
            <div className="flex flex-col justify-center items-end">
              <div className=" text-xl font-bold">
                {Number(spinGameData.total_players)}/100
              </div>
