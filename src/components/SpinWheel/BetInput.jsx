...
const BetInput = () => {
    ...
    const handleAddSelection = async () => {
        ...
        var placeBetResult = await spinActor.place_bet(
            totalEntry * 100000000,
            Number(spinGameData.id)
        );
        ...
        <div className="">
            ...
            <div className="flex mb-4 items-center">
                ...
                <input
                    ...
                    value={(icpBalance / 100000000).toLocaleString()}
                    disabled
                />
            </div>
            <div className="flex mb-4 items-center">
                ...
                <input
                    ...
                    id="totalEntryInput"
                    className="flex-1 rounded-md border border-gray-300 px-3 py-2"
                    onChange={handleTotalEntryChange}
                    value={totalEntry}
                    min="0"
                />
            </div>
            ...
            <hr />
            <button
                className={`w-full mt-4 py-1.5 rounded-md text-white font-bold text-lg ${loading ? 'bg-gray-400' : 'bg-dark-blue'}`}
