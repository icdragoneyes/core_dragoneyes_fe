...
const EyeRoll = () => {
  ...
  const chartData = {
    labels: prizes.map((prize) =>
      typeof prize === "number" ? `${prize} EYES` : prize
    ),
    datasets: [
      {
      ...
      <div className="w-full min-h-screen flex flex-col bg-gray-800 items-center justify-start p-4 pb-24 overflow-y-auto overflow-x-hidden">
        ...
        <div className="w-full max-w-md bg-gray-800 rounded-lg shadow-lg mb-8 p-6">
          ...
          <div className="flex justify-between items-center">
            <div className="text-white">
              ...
              <p className="text-xl font-bold">
                {eyesBalance.toLocaleString()} EYES
              </p>
            </div>
          ...
          <p className="text-white text-xs mt-1">
            Progress to be {level < 14 ? levelNames[level + 1] : "Max Level"}:{" "}
        ...
        <AnimatePresence>
          {showModal && (
            ...
            >
              ...
              >
                <motion.h2
                  className="text-4xl font-bold mb-6 text-white font-passion"
                ...
                <motion.p
                  className="text-white text-xl mb-8 font-passion"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
        ...
        <button
          className={`z-10 mt-6 px-8 py-3 rounded-full text-white font-bold text-lg transition-all duration-300 ${
            (freeSpin > 0 || eyesBalance >= 10) && canSpin
        ...
        <small className="mt-4 text-slate-100 text-xs z-10">
          or you can swipe down the wheel
        </small>
