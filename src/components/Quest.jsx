...
const Quest = () => {
  ...
  const claimReward = (id) => {
    ...
    if (quest && quest.completed && !quest.claimed) {
      ...
      toast.error(
        "Cannot claim reward. Make sure the quest is completed and not already claimed."
      );
    }
  };
      ...
      <div className="flex justify-center h-full relative z-10 font-passion pb-20">
        ...
        >
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="space-y-3 overflow-y-auto no-scrollbar flex-grow"
          >
            {/* card invite friends */}
            <motion.div
              variants={itemVariants(0)}
              className="bg-[#EFDECA] rounded-lg p-4 flex flex-col justify-between gap-1"
            >
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-1">
                  <span className="text-[#E35721]">
                    {Number(10000).toLocaleString()}
                  </span>
                  <span className="bg-gradient-to-r from-[#5100A3] to-[#F76537] text-transparent bg-clip-text font-bold">
                    EYES
                  </span>
                </div>
              </div>
              <div className="flex items-center justify-between gap-2">
                <p className="text-[6px] text-gray-700 font-semibold font-inter">
                  Your friend will get 0.3 SOL airdrop, and you&apos;ll get 10K
                  EYES when they play the game.
                </p>
                <div className="flex justify-between items-center">
                  <div className="bg-[#FDF8F0] rounded-l-lg p-1 border-2 border-dashed border-[#EA8101] flex-grow">
                    <div className="flex justify-between items-center">
                      <span className="text-[#EA8101] text-sm">
                        {referralCode}
                      </span>
                      <button
                        onClick={() =>
                  ...
                  <button
                    ...
                    className="bg-[#D57500] px-3 py-2 text-white text-xs rounded-r-lg flex items-center justify-center gap-1"
                  >
                    Share
                    <img
                      src={share_logo}
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-1">
                    <span
                      className={`${
                        quest.claimed ? "text-[#7c7c7c]" : "text-[#E35721]"
                      }`}
                    >
                    ...
                    <span
                      className={`${
                        quest.claimed
                          ? "text-[#7c7c7c]"
                          : "bg-gradient-to-r from-[#5100A3] to-[#F76537] text-transparent bg-clip-text font-bold"
                      }`}
                    >
                      EYES
                    </span>
                ...
                <div className="flex justify-end mt-2">
                  <button
                    ...
                    className={`px-3 py-2 text-white text-xs w-[136px] rounded-lg flex items-center justify-center gap-1 ${
                      quest.claimed ? "cursor-not-allowed" : ""
                    }`}
                    style={{
