...
const Options = ({ selected, img, name, onClick, disabled, isSelected, isActive }) => {
  const buttonClasses = `lg:p-6 sm:p-2 md:mx-4 mx-2 basis-1/3 rounded-lg shadow focus:outline-none focus:ring-4 focus:ring-blue-500 bg-[#1e3557] border-gray-700 flex-grow ${
