...
const Options = ({ selected, img, name, onClick, disabled, isSelected }) => (
  <button
    ...
    className={`lg:p-6 sm:p-2 mx-2 basis-1/3 bg-white border border-gray-200 rounded-lg shadow focus:outline-none dark:bg-gray-800 dark:border-gray-700 ${
      disabled ? "cursor-not-allowed opacity-50" : "hover:scale-105 hover:shadow-lg hover:ring-4 hover:ring-yellow-400"
    } ${isSelected ? "scale-105 shadow-lg ring-4 ring-yellow-400" : ""}`}
    disabled={disabled}
  >
