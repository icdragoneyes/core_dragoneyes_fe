...
const colors = [
    ...
    "#673ab7", "#cddc39", "#9e9e9e", "#ff5722", "#03a9f4",
    "#ffeb3b", "#607d8b", "#ff4081", "#4caf50", "#3f51b5",
    "#00bcd4", "#e91e63", "#f44336", "#ffc107", "#9e9e9e",
    "#673ab7", "#cddc39", "#03a9f4", "#8bc34a", "#ff9800",
    "#2196f3", "#ff5722", "#9c27b0", "#607d8b", "#ffeb3b",
    "#ff4081", "#4caf50", "#f44336", "#00bcd4", "#e91e63",
    "#ffc107", "#9c27b0", "#673ab7", "#03a9f4", "#9e9e9e",
    "#ff5722", "#cddc39", "#8bc34a", "#2196f3", "#607d8b",
    "#ffeb3b", "#ff4081", "#4caf50", "#f44336", "#00bcd4",
    "#e91e63", "#ffc107", "#9c27b0", "#673ab7", "#03a9f4",
    "#9e9e9e", "#ff5722", "#cddc39", "#8bc34a", "#2196f3",
    "#607d8b", "#ffeb3b", "#ff4081", "#4caf50", "#f44336",
    "#00bcd4", "#e91e63", "#ffc107", "#9c27b0", "#673ab7",
    "#03a9f4", "#9e9e9e", "#ff5722", "#cddc39", "#8bc34a",
    "#2196f3", "#607d8b", "#ffeb3b", "#ff4081", "#4caf50",
    "#f44336", "#00bcd4", "#e91e63", "#ffc107", "#9c27b0",
    "#673ab7", "#03a9f4", "#9e9e9e", "#ff5722", "#cddc39",
    "#8bc34a", "#2196f3", "#607d8b", "#ffeb3b", "#ff4081"
];
        ...
        <div className="bg-background-land bg-cover xl:h-screen relative">
            <div className="flex h-full xl:h-[860px] mx-auto max-w-7xl flex flex-col justify-center items-start gap-0 xl:gap-12 xl:flex-row">
                ...
                <RoundInfo
                    ...
                    spinGameData={spinGameData}
                    winChance={calculateWinChance(Number(spinGameData.totalReward), Number(spinGameData.currentGameBet))}
                />
                <MobileRoundInfo
                    players={players}
                    walletAddress={walletAddress}
            ...
            <img
                ...
                className="z-0 rounded-lg w-full absolute bottom-0 right-0 hidden lg:block lg:w-4/12 2xl:w-2/6"
                alt="dragon-bg"
            />
        </div>
    );
